...
export const CLASSES: ClassLevel[] = [
  {
    ...
    subjects: [
      ...
      },
      {
        ...
        color: 'bg-indigo-600',
        chapters: [
          { id: '10-m-1', title: 'एक चर वाले द्विघात समीकरण (Quadratic Equation with one variable)' },
          { id: '10-m-2', title: 'सरल ब्याज (Simple Interest)' },
          { id: '10-m-3', title: 'वृत्त से संबंधित प्रमेय (Theorem related to circle)' },
          { id: '10-m-4', title: 'आयताकार समांतर षट्फलक या घनाभ (Rectangular Parallelopiped as Cuboid)' },
          { id: '10-m-5', title: 'अनुपात और समानुपात (Ratio and proportion)' },
          { id: '10-m-6', title: 'चक्रवृद्धि ब्याज और समान वृद्धि या ह्रास दर (Compound interest and uniform rate of increase and decrease)' },
          { id: '10-m-7', title: 'वृत्तस्थ कोण संबंधित प्रमेय (Theorems related to angle in a circle)' },
          { id: '10-m-8', title: 'लंब वृत्ताकार बेलन (Right circular cylinder)' },
          { id: '10-m-9', title: 'द्विघात करणी (Quadratic Surd)' },
          { id: '10-m-10', title: 'चक्रीय चतुर्भुज संबंधित प्रमेय (Theorems related to cyclic Quadrilateral)' },
          { id: '10-m-11', title: 'एक चर वाले द्विघात समीकरण (Quadratic equation in one variable)' },
          { id: '10-m-12', title: 'रचना: त्रिभुज के परिवृत्त और अंतर्वृत्त की रचना (Construction: Construction of circum circle and incircle of a triangle)' },
          { id: '10-m-13', title: 'गोलक (Sphere)' },
          { id: '10-m-14', title: 'भेद (Variation)' },
          { id: '10-m-15', title: 'साझा व्यापार (Partnership Business)' },
          { id: '10-m-16', title: 'वृत्त की स्पर्श रेखा संबंधित प्रमेय (Theorems related to tangent to a circle)' },
          { id: '10-m-17', title: 'लंब वृत्ताकार शंकु (Right circular cone)' },
          { id: '10-m-18', title: 'सदृशता (Similarity)' },
          { id: '10-m-19', title: 'रचना: वृत्त की स्पर्श रेखा की रचना (Construction: construction of a tangent to circle)' },
          { id: '10-m-20', title: 'विभिन्न ठोस वस्तुओं से संबंधित वास्तविक जीवन की समस्याएं (Real life problem related to different solid object)' },
          { id: '10-m-21', title: 'त्रिकोणमिति: कोण मापन की अवधारणा (Trigonometry: concept of measurement of angle)' },
          { id: '10-m-22', title: 'रचना: मध्य समानुपाती का निर्धारण (Construction: Determination of mean proportion)' },
          { id: '10-m-23', title: 'पाइथागोरस प्रमेय (Pythagoras theorem)' },
          { id: '10-m-24', title: 'त्रिकोणमितीय अनुपात और त्रिकोणमितीय सर्वसमिकाएँ (Trigonometric Ratio and trigonometric identities)' },
          { id: '10-m-25', title: 'त्रिकोणमितीय अनुपातों का अनुप्रयोग: ऊँचाई और दूरी (Application of Trigonometric Ratios: Height and Distance)' },
      ...
      },
      {
        ...
        color: 'bg-teal-600',
        chapters: [
          { id: '10-g-1', title: 'बहिर्जात प्रक्रियाएँ और उनके द्वारा निर्मित भू-आकृतियाँ (Exogenetic processes and resultant landforms)' },
    ...
    subjects: [
      {
        ...
        color: 'bg-red-500',
        chapters: [
          { id: '9-h-p1', title: 'काव्य-खण्ड: विनय के पद' },
          { id: '9-h-p2', title: 'काव्य-खण्ड: धीरे-धीरे उतर क्षितिज से' },
          { id: '9-h-p3', title: 'काव्य-खण्ड: पेड़ का दर्द' },
          { id: '9-h-p4', title: 'काव्य-खण्ड: जरुरतों के नाम पर' },
          { id: '9-h-p5', title: 'काव्य-खण्ड: कलकत्ता' },
          { id: '9-h-p6', title: 'काव्य-खण्ड: सबसे खतरनाक' },
          { id: '9-h-p7', title: 'काव्य-खण्ड: यमराज की दिशा' },
          { id: '9-h-p8', title: 'काव्य-खण्ड: कर चले हम फ़िदा' },
          { id: '9-h-g1', title: 'गद्य-खण्ड: स्त्री-शिक्षा के विरोधी कुतर्कों का खण्डन' },
          { id: '9-h-g2', title: 'गद्य-खण्ड: हिंसा परम धर्मः' },
          { id: '9-h-g3', title: 'गद्य-खण्ड: संस्कृति है क्या?' },
          { id: '9-h-g4', title: 'गद्य-खण्ड: ठेले पर हिमालय' },
          { id: '9-h-g5', title: 'गद्य-खण्ड: भोलाराम का जीव' },
          { id: '9-h-g6', title: 'गद्य-खण्ड: वापसी' },
          { id: '9-h-g7', title: 'गद्य-खण्ड: पर्यावरण संरक्षण' },
          { id: '9-h-g8', title: 'गद्य-खण्ड: गिरगिट' },
      ...
      },
      {
        ...
        color: 'bg-orange-500',
        chapters: [
          { id: '9-e-1', title: 'Chapter 1' },
          { id: '9-e-2', title: 'Chapter 2' },
          { id: '9-e-3', title: 'Chapter 3' },
          { id: '9-e-4', title: 'Chapter 4' },
          { id: '9-e-5', title: 'Chapter 5' },
          { id: '9-e-6', title: 'Chapter 6' },
          { id: '9-e-7', title: 'Chapter 7' },
          { id: '9-e-8', title: 'Chapter 8' },
          { id: '9-e-9', title: 'Chapter 9' },
          { id: '9-e-10', title: 'Chapter 10' },
          { id: '9-e-11', title: 'Chapter 11' },
          { id: '9-e-12', title: 'Chapter 12' },
          { id: '9-e-g1', title: 'Textual Grammar, Article and Preposition, Voice change, Forms of Verbs' },
          { id: '9-e-g2', title: 'Sentences -- Simple, Compound, Complex' },
          { id: '9-e-g3', title: 'Transformation of Sentences, Adverb, Phrasal Verb, Clauses' },
          { id: '9-e-w1', title: 'Dialogue Writing, Story Writing, Process Writing, Biography Writing' },
          { id: '9-e-w2', title: 'Report Writing, Summary Writing, Letter Writing (Formal), Paragraph Writing' }
        ]
      },
      {
        id: 'math',
        ...
        chapters: [
          ...
          { id: '9-m-2', title: 'घातांक के नियम (Laws of Indices)' },
          { id: '9-m-3', title: 'लेखाचित्र (Graph)' },
          { id: '9-m-4', title: 'स्थानांक ज्यामिति: दूरी निकालने का सूत्र (Coordinate Geometry: Distance Formula)' },
          { id: '9-m-5', title: 'सरल युगपत समीकरण (Linear Simultaneous Equations)' },
          { id: '9-m-6', title: 'समांतर चतुर्भुज के गुण (Properties of Parallelogram)' },
          { id: '9-m-7', title: 'बहुपदी व्यंजक (Polynomials)' },
          { id: '9-m-8', title: 'गुणनखंड करना (Factorisation)' },
          { id: '9-m-9', title: 'तिर्यक और मध्य बिन्दु युक्त प्रमेय (Transversal and Mid-Point Theorem)' },
          { id: '9-m-10', title: 'लाभ और हानि (Profit and Loss)' },
          { id: '9-m-11', title: 'सांख्यिकी (Statistics)' },
          { id: '9-m-12', title: 'क्षेत्रफल वाले प्रमेय (Theorems on Area)' },
          { id: '9-m-13', title: 'निर्मेय (Construction)' },
          { id: '9-m-14', title: 'निर्मेय- एक चतुर्भुज के क्षेत्रफल के बराबर त्रिभुज का निर्माण (Construction of a triangle equal in area to a quadrilateral)' },
          { id: '9-m-15', title: 'त्रिभुज और चतुर्भुज की परिसीमा (Perimeter and Area of Triangle and Quadrilateral)' },
          { id: '9-m-16', title: 'वृत्त की परिधि (Circumference of Circle)' },
          { id: '9-m-17', title: 'संगामी रेखाओं वाले प्रमेय (Theorems on Concurrence)' },
          { id: '9-m-18', title: 'वृत्त का क्षेत्रफल (Area of Circle)' },
          { id: '9-m-19', title: 'स्थानांक ज्यामिति : सरल रेखा खंड का आंतरिक और वहीं विभाजन (Coordinate Geometry: Internal and External Division of Straight Line Segment)' },
          { id: '9-m-20', title: 'स्थानांक ज्यामिति : त्रिभुजाकृति क्षेत्र का क्षेत्रफल (Coordinate Geometry: Area of Triangular Region)' },
          { id: '9-m-21', title: 'Logarithm' }
        ]
      },
      {
        id: 'physci',
        ...
        chapters: [
          ...
          { id: '9-ps-2', title: 'बल एवं गति (Force and Motion)' },
          { id: '9-ps-3', title: 'परमाणु संरचना (Atomic Structure)' },
          { id: '9-ps-4', title: 'मोल धरना (Mole Concept)' },
          { id: '9-ps-5', title: 'पदार्थ गठन तथा अनु (Matter, Structure and Properties)' },
          { id: '9-ps-6', title: 'घोल (Solution)' },
          { id: '9-ps-7', title: 'अम्ल क्षार और लवण (Acids, Bases and Salts)' },
          { id: '9-ps-8', title: 'कार्य शक्ति तथा ऊर्जा (Work, Power and Energy)' },
          { id: '9-ps-9', title: 'ध्वनि (Sound)' },
          { id: '9-ps-10', title: 'ऊष्मा (Heat)' },
          { id: '9-ps-11', title: 'मिजीवों के अवयबो का पृथक करना (Separation of Components of Mixtures)' },
          { id: '9-ps-12', title: 'जल (Water)' }
        ]
      },
      {
        id: 'lifesci',
    ...
    subjects: [
      {
        ...
        color: 'bg-red-400',
        chapters: [
          { id: '8-h-p1', title: 'पद्य खण्ड: सूर के पद' },
          { id: '8-h-p2', title: 'पद्य खण्ड: भारतमाता का मंदिर' },
          { id: '8-h-p3', title: 'पद्य खण्ड: प्रियतम' },
          { id: '8-h-p4', title: 'पद्य खण्ड: जनगीत' },
          { id: '8-h-p5', title: 'पद्य खण्ड: यदि फूल नहीं बो सकते तो' },
          { id: '8-h-p6', title: 'पद्य खण्ड: कोई नहीं पराया' },
          { id: '8-h-p7', title: 'पद्य खण्ड: नई नारी' },
          { id: '8-h-p8', title: 'पद्य खण्ड: वापसी' },
          { id: '8-h-g1', title: 'गद्य खण्ड: श्रम की प्रतिष्ठा' },
          { id: '8-h-g2', title: 'गद्य खण्ड: सुभान खाँ' },
          { id: '8-h-g3', title: 'गद्य खण्ड: नीलू' },
          { id: '8-h-g4', title: 'गद्य खण्ड: भिखारिन' },
          { id: '8-h-g5', title: 'गद्य खण्ड: टोबा टेक सिंह' },
          { id: '8-h-g6', title: 'गद्य खण्ड: अपराजिता' },
          { id: '8-h-g7', title: 'गद्य खण्ड: शाप मुक्ति' },
          { id: '8-h-g8', title: 'गद्य खण्ड: पानी की कहानी' },
